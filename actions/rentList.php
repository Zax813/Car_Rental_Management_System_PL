...
{
    $stmt = $db->query('SELECT idwypozyczenia, MR.NAZWAMARKI AS MARKA, MD.NAZWAMODEL AS MODEL, A.rejestracja, K.IMIE, K.NAZWISKO, K.TELEFON, datapoczatek, datakoniec, przebiegstart, przebiegkoniec, suma, zaplacono, W.uwagi, realizacja
                        FROM wypozyczenia w
