...
<div class='form-outline mx-5 my-3'>
    <a class='btn btn-info btn-sm' href='index.php?action=carServiceAdd&event=list' title='Lista' name='list'><i class='bi bi-arrow-left-circle'></i> Powrót</a>
</div>

<!-- Formularz wpisywania nowego serwisu -->
<div class='form-outline mx-5 d-flex justify-content-center'>
    <form class='form-horizontal' action="index.php?action=carServiceAdd" method="post">
        ...
        <div class="row mb-2">
            ...
            <div class='col-md-6 mb-2'>
                ...
                <div class='controls'>
                    <input type="date" class='col-md-12' id="datapoczatek" name="datapoczatek" value="<?php echo $today; ?>">
                </div>
            </div>
            ...
            <div class='col-md-6 mb-2'>
                ...
                <div class='controls'>
                    <input type="date" class='col-md-12' id="datakoniec" name="datakoniec" value="<?php echo $nextDay; ?>">
                </div>
            </div>
        </div>
        ...
        <div class='form-group mb-2'>
            ...
            <div class='controls'>
                <input type="text" class="col-md-12" id="nazwaserwis" name="nazwaserwis">
        ...
        <div class='form-group mb-2'>
            ...
            <div class='controls'>
                <textarea class="col-md-12" id="opis" name="opis" rows="5" cols="23"></textarea>
        ...
        <div class='form-group mb-2'>
            ...
            <div class='controls'>
                <input type="number" class="col-md-12" id="koszt" name="koszt" step="0.01" min="0" placeholder="0.00">
