<h2 class='form-outline mx-5 my-2'>Edycja klienta</h2>

<div class='form-outline mx-5 my-3'>
    <a class='btn btn-info btn-sm' href='index.php?action=clientEdit&event=list' title='Lista' name='list'><i class='bi bi-arrow-left-circle'></i> Powrót</a>
</div>
...
<div class='form-outline mx-5 d-flex justify-content-center'>
    ...
    <form class='form-horizontal' action="index.php?action=clientEdit" id="clientEditForm" method="post">
